...
public class DatabaseHandler extends Configs {
    ...
    public void updateUserPermission(String username, String newPermission) {
        String updateQuery = "UPDATE " + Const.USER_TABLE + " SET " +
                Const.USER_PERMISSION + " = ? WHERE " + Const.USER_USERNAME + " = ?";

        try {
            PreparedStatement preparedStatement = getDbConnection().prepareStatement(updateQuery);
            preparedStatement.setString(1, newPermission);
    ...
    public void deleteVehiclePolicy(String policyId) {
        String deleteQuery = "DELETE FROM " + VehiclePolicyConst.POLICY_TABLE + " WHERE " +
                VehiclePolicyConst.POLICY_ID + " = ?";
    ...
    public void deleteBuildPolicy(String policyId) {
        String deleteQuery = "DELETE FROM " + BuildPolicyConst.POLICY_TABLE + " WHERE " +
                BuildPolicyConst.POLICY_ID + " = ?";
    ...
    public void deleteItemsPolicy(String policyId) {
        String deleteQuery = "DELETE FROM " + ItemsPolicyConst.POLICY_TABLE + " WHERE " +
                ItemsPolicyConst.POLICY_ID + " = ?";
    ...
    public void deleteBusinessPolicy(String policyId) {
        String deleteQuery = "DELETE FROM " + BusinessPolicyConst.POLICY_TABLE + " WHERE " +
                BusinessPolicyConst.POLICY_ID + " = ?";
